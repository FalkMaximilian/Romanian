...
%
%
\subsection{Verbi importanți - Wichtige Verben}
%
\index{a fi}
\begin{center}
...
%
%
\section{Baze - Grundlagen}
%
\subsection{Plural}
Beim Bilden des Plurals von Substantiven kommt es oft zu Veränderungen bei den vorherstehenden Buchstaben. Anhand der Endung 
kann man oft auch auf das Geschlecht des Substantives schließen. Ist die Endung ein \emph{ă} deutet dies auf singular feminin hin. 
Endet ein Wort auf \emph{i} so ist die Chance hoch, dass es ein maskulines 
Substantiv im Plural ist. Endet es auf \emph{e} ist das Wort wahrscheinlich feminin plural.\\
\newline 
...
\begin{center}
  \begin{tabular}{ |l|l||l|l|  }
    \hline
    \multicolumn{2}{|c||}{Maskulin} & \multicolumn{2}{c|}{Feminin}\\
    \hline
...
%
%
\subsection{Numere - Zahlen}
1 - unu, 2 - doi, 3 - trei, 4 - patru, 5 - cinci, 6 - șase, 7 - șapte, 8 - opt,
9 - nouă, 10 - zece\\
\newline
11 - unsprezece, 12 - doisprezece, 13 - treisprezece, \textcolor{red}{14 - paisprezece}, 15 - 
cincisprezece, \textcolor{red}{16 - șaisprezece}, 17 - șaptesprezece, 18 - optsprezece, 19 - 
nouăsprezece, 20 - douăzeci\\
\newline
21 - douăzeci și unu, 22 - douăzeci și doi/două, \dots\\
\newline
30 - treizeci, 40 - patruzeci, 50 - cincizeci, \textcolor{red}{60 - șaizeci}, \dots, 100 - o sută, 200 - două sute\\
\newline
...
\begin{center}
  \begin{tabular}{ | C{1.7cm}| C{1.7cm} | C{1.7cm} | C{2cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} |}
    \hline
...
\pagebreak
%
\section{Oră și verbi- Uhrzeit und Verben}
...
%
\pagebreak
\section{Dată și articul hotărât}
...
%
\newpage
\section{Forma de politețe și 'Să'}
...
\section{Verbi reflexivă și trecut}
...
\section{Conjunctiv Prezent - Konjunktiv Präsens}
...
\pagebreak
\section{Adverbe de timp - Zeitadverbien}
\subsection*{Niciodată - Nie}
...
%
\subsection*{Restul - Alles andere}
...
%
%
\subsection{Adjectivul posesiv - Possesivpronomen}
...
\end{center}
%
\section{Pronumele personal în acuzativ}
Die Personalpronomen im Akkusativ brauchen wir um beispielsweise "Ich sehe sie", 
"Er hilft ihnen" oder "Ich kaufe sie/ihn/es" zu sagen.
%
\subsection{Forme neaccentuate}
\begin{center}
  \begin{tabular}{ | C{1.7cm}| C{1.7cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} |}
    \hline
      ...
      & 1 & 2 & 3 & 1 & 2 & 3\\
    \hline
    \shortstack{\\m.\\f.} & mă & te & \shortstack{\\îl\\o} & ne & vă & \shortstack{\\îi\\le}\\
    \hline
  \end{tabular}
\end{center}
%
Er hilft mir das Essen zu kochen. $\rightarrow$ El mă ajută să gătesc măncarea.\\
Ich helfe dir die Aufgaben zu machen. $\rightarrow$ Eu te ajut să faci exercițiile.\\
Ich kaufe einen Kühlschrank. / Ich kaufe ihn. $\rightarrow$ Cumpăr un frigider. / Îl cumpăr.\\
Du kaufst ein Buch. / Du kaufst es. $\rightarrow$ Cumperi o carte. / O cumperi.\\
\newline
Siehst du uns? $\rightarrow$ Ne vezi?\\
Ich bringe euch Brot. $\rightarrow$ Vă aduc pâine.\\
Ich stelle sie (die Schuhe) in den Schrank $\rightarrow$ Îi (pantofii) pun în dulap.\\
Sie schreibt die Übungen. / Sie schreibt sie. $\rightarrow$ Ea scrie exercițiile. / Ea le scrie.\\
\newline
Siehst du mich? / Ja, ich sehe dich. $\rightarrow$ Mă vezi? / Da, te văd.
%
\subsubsection*{Forme neaccentuate cu nu}
Beim Verwenden der Formen îl, o und îi im indikativ präsens mit nu werden die Formen zusammengezogen 
und in einer Silbe ausgesprochen.
\begin{equation*}
  \text{NU +}
  \begin{cases}
    \text{îl} & \text{nu-l} \\
...
%
\begin{center}
  Îl aștepți? $\rightarrow$ Nu-l aștept.\\
  Îi aștepți? $\rightarrow$ Nu-i aștept.
\end{center}
%
\begin{center}
  \rule{6cm}{0.4pt}
...
%
\begin{center}
  O aștepți? $\rightarrow$ N-o aștept
\end{center}
%
%
\subsubsection*{Forme neaccentuate cu să}
Im konjunktiv präsens verhalten sich die Personalpronomen genau gleich wie im indikativ Präsens mit nu.
\begin{equation*}
  \text{Să +}
  \begin{cases}
    \text{îl} & \text{să-l} \\
...
%
\begin{center}
  Du sollst auf ihn warten! $\rightarrow$ Să-l aștepți.\\
  Du sollst auf sie (pl.) warten! $\rightarrow$ Să-i aștepți.
\end{center}
%
\begin{center}
  \rule{6cm}{0.4pt}
...
%
\begin{center}
  Du sollst ihr helfen! $\rightarrow$ S-o ajuți!
\end{center}
%
Verneint man etwas im konjunktiv so wird das Personalpronomen wieder mit dem \emph{nu} zusammengezogen. Z.B. \emph{Să nu-i aștepți.}
%
%
\subsubsection*{Pronumele în perfect cumpus}
El \emph{(mă a)} m-a vazut.\\
El te-a vazut.\\
El \emph{(îl a)} l-a vazut.\\
El a vazut-o.\\
El ne-a vazut.\\
El \emph{(vă a)} v-a vazut.\\
El \emph{(îi a)} i-a vazut.\\
El le-a vazut.\\
%
\subsection{Forme accentuate}
\begin{center}
  \begin{tabular}{ | C{1.7cm}| C{1.7cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} | C{1.7cm} |}
    \hline
      & \multicolumn{3}{c|}{Singular} & \multicolumn{3}{c|}{Plural}\\
      ...
      & 1 & 2 & 3 & 1 & 2 & 3\\
    \hline
    \shortstack{\\m.\\f.} & mine & tine & \shortstack{\\el\\ea} & noi & voi & \shortstack{\\ei\\ele}\\
    \hline
  \end{tabular}
\end{center}
%
Das Personalpronomen im Akkusativ hat auch eine lange (akzentuierte) Form. Sie wird 
hauptsächlich verwendet um etwas nochmals zu betonen oder in 
bestimmten Formulierungen.\\
\newline
Wen suchst du? Dich! $\rightarrow$ Pe cine cauți? Pe tine!\\
Wen siehst du? Ihn/Sie. $\rightarrow$ Pe cine vezi? Pe el/ea.
%
%
%
